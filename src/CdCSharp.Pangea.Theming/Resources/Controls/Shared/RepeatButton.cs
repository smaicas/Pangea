...
namespace CdCSharp.AvaToolKit.Theming.Controls;
...
public class RepeatButton : Button
{
    ...
    private void RepeatTimerOnTick(object? sender, EventArgs e)
    {
        ...
        if (_repeatTimer!.Interval != interval) _repeatTimer.Interval = interval;
        OnClick();
    }
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == IsPressedProperty && change.GetNewValue<bool>() == false) StopTimer();
    }
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        if (e.GetCurrentPoint(this).Properties.IsLeftButtonPressed) StartTimer();
    }
    ...
    protected override void OnPointerReleased(PointerReleasedEventArgs e)
    {
        ...
        if (e.InitialPressMouseButton == MouseButton.Left) StopTimer();
    }
}